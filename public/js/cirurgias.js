...
const OPME = (() => {
    ...
    function switchTab(tabId) {
        ...
        // Controle do botão Inserir Item Hosp.
        const btnSaldoAtaHospital = document.getElementById('btnNewSaldoAtaHospital');
        if (btnSaldoAtaHospital) {
            if (tabId === 'saldoatahospital') {
                btnSaldoAtaHospital.classList.remove('hidden');
            } else {
                btnSaldoAtaHospital.classList.add('hidden');
            }
        }
    ...
    function handleRowClick(e, idx, tab) {
        ...
        } else if (tab === 'saldoatahospital') {
            openSaldoAtaHospitalModal(idx);
        } else {
    ...
    function toggleFullscreenGrid() {
        ...
        const btns = document.querySelectorAll('.btn-fullscreen-grid');
    ...
    return {
        ...
        saveSaldoAta,
        openSaldoAtaHospitalModal,
        closeSaldoAtaHospitalModal,
        toggleSaldoAtaHospitalProduct,
        addSaldoAtaHospitalProduct,
